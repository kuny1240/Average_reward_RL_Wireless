...
class Env():
    ...
    def reset(self):
        ...
        self.inds = torch.zeros([self.n_enbs, 5]).long()
...
#         breakpoint()
    ...
    def step(self, actions):
        ...
        plan = [self.inds[i][actions[i]]if actions[i]<4 else -1 for i in range(self.n_enbs)] # the i_th enb shoot at the plan[i]_th ue
        #print(plan)
